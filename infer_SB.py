...
if __name__ == '__main__':
    ...
    for iter, (img_name, img_list, label) in enumerate(infer_data_loader):
        ...
        # print('stage 1 reached: load image')
        ...
        thread_pool = pyutils.BatchThreader(_work, list(enumerate(img_list)),
                                            batch_size=16, prefetch_size=0, processes=args.num_workers)

        # print('stage 2 reached: threadpool')

        cam_list = thread_pool.pop_results()

        # print('stage 2.5 reached: threadpool pop results')
        ...
        # print('stage 3 reached: norm_cam')
